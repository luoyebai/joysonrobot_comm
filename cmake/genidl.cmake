...
function(gendds_for_idl IDL_LIB_NAME)
    ...
    set(IDL_GEN_INCLUDE_DIR ${CMAKE_SOURCE_DIR}/include/${TARGET_NAME}/idl)
    ...
    foreach(idl ${IDL_FILES})
        ...
        add_custom_command(
            ...
            COMMAND ${_DDSGEN_SCRIPT} ${IDL_NAME}
    ...
    target_include_directories(${IDL_LIB_NAME} PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/include/${TARGET_NAME})
