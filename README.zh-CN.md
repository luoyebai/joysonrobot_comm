...
1. 该SDK实现对应的[头文件](http://192.168.124.192:3000/TanJiachun/joysonrobot_sdk_v2/src/branch/main/include)和[源文件](http://192.168.124.192:3000/TanJiachun/joysonrobot_sdk_v2/src/branch/main/src)。

2. 该SDK使用的[IDL文件](http://192.168.124.192:3000/TanJiachun/joysonrobot_sdk_v2/src/branch/main/idl)和[根据IDL生成代码的脚本](http://192.168.124.192:3000/TanJiachun/joysonrobot_sdk_v2/src/branch/main/third_party/scripts/ddsgen)。

3. 该SDK对应的[测试代码](http://192.168.124.192:3000/TanJiachun/joysonrobot_sdk_v2/src/branch/main/tests)。

4. 该SDK对应的[Python接口实现](http://192.168.124.192:3000/TanJiachun/joysonrobot_sdk_v2/src/branch/main/python)。
...
想要使用生成器的话，请先了解[IDL文件的编写](https://fast-dds.docs.eprosima.com/en/2.6.x/fastddsgen/dataTypes/dataTypes.html)，将编写IDL文件放入该项目下的idl文件夹，然后使用以下命令生成工具。
