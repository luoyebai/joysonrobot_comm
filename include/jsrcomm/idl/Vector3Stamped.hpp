...
public:
     ...
     */
    FASTDDS_EXPORTED_API Vector3Stamped();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~Vector3Stamped() override;
     ...
     * @param x Reference to the object geometry_msgs::msg::Vector3Stamped that will be copied.
     */
    FASTDDS_EXPORTED_API Vector3Stamped& operator =(
            const Vector3Stamped& x);
     ...
     */
    FASTDDS_EXPORTED_API void vector(
     ...
     */
    FASTDDS_EXPORTED_API const geometry_msgs::msg::Vector3& vector() const;

    /*!
     * @brief This function returns a reference to member vector
     * @return Reference to member vector
     */
    FASTDDS_EXPORTED_API geometry_msgs::msg::Vector3& vector();
