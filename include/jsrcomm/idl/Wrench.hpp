...
public:
     ...
     */
    FASTDDS_EXPORTED_API Wrench();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~Wrench() override;
     ...
     * @param x Reference to the object geometry_msgs::msg::Wrench that will be copied.
     */
    FASTDDS_EXPORTED_API Wrench& operator =(
            const Wrench& x);
     ...
     */
    FASTDDS_EXPORTED_API void force(
     ...
     */
    FASTDDS_EXPORTED_API const geometry_msgs::msg::Vector3& force() const;

    /*!
     * @brief This function returns a reference to member force
     * @return Reference to member force
     */
    FASTDDS_EXPORTED_API geometry_msgs::msg::Vector3& force();
     ...
     */
    FASTDDS_EXPORTED_API const geometry_msgs::msg::Vector3& torque() const;

    /*!
     * @brief This function returns a reference to member torque
     * @return Reference to member torque
     */
    FASTDDS_EXPORTED_API geometry_msgs::msg::Vector3& torque();
