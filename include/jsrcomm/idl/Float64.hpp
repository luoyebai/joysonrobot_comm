 ...
 * @ingroup Float64
 */
class Float64 : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API Float64();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~Float64() override;
     ...
     * @param x Reference to the object std_msgs::msg::Float64 that will be copied.
     */
    FASTDDS_EXPORTED_API Float64& operator =(
            const Float64& x);
     ...
     */
    FASTDDS_EXPORTED_API double data() const;

    /*!
     * @brief This function returns a reference to member data
     * @return Reference to member data
     */
    FASTDDS_EXPORTED_API double& data();
