 ...
 * @ingroup Empty
 */
class Empty : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API Empty();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~Empty() override;
     ...
     * @param x Reference to the object std_msgs::msg::Empty that will be copied.
     */
    FASTDDS_EXPORTED_API Empty& operator =(
            const Empty& x);
     ...
     */
    FASTDDS_EXPORTED_API void structure_needs_at_least_one_member(
     ...
     */
    FASTDDS_EXPORTED_API uint8_t structure_needs_at_least_one_member() const;
     ...
     */
    FASTDDS_EXPORTED_API uint8_t& structure_needs_at_least_one_member();
