 ...
 */
class JoyFeedbackArray : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API JoyFeedbackArray();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~JoyFeedbackArray() override;
     ...
     * @param x Reference to the object sensor_msgs::msg::JoyFeedbackArray that will be copied.
     */
    FASTDDS_EXPORTED_API JoyFeedbackArray& operator =(
            const JoyFeedbackArray& x);
     ...
     */
    FASTDDS_EXPORTED_API void array(
     ...
     */
    FASTDDS_EXPORTED_API const std::vector<sensor_msgs::msg::JoyFeedback>& array() const;

    /*!
     * @brief This function returns a reference to member array
     * @return Reference to member array
     */
    FASTDDS_EXPORTED_API std::vector<sensor_msgs::msg::JoyFeedback>& array();
