 ...
 */
class FluidPressure : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API FluidPressure();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~FluidPressure() override;
     ...
     * @param x Reference to the object sensor_msgs::msg::FluidPressure that will be copied.
     */
    FASTDDS_EXPORTED_API FluidPressure& operator =(
            const FluidPressure& x);
     ...
     */
    FASTDDS_EXPORTED_API void fluid_pressure(
