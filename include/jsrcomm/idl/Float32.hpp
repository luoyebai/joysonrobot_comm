...
public:
     ...
     */
    FASTDDS_EXPORTED_API Float32();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~Float32() override;
     ...
     * @param x Reference to the object std_msgs::msg::Float32 that will be copied.
     */
    FASTDDS_EXPORTED_API Float32& operator =(
            const Float32& x);
     ...
     */
    FASTDDS_EXPORTED_API float data() const;

    /*!
     * @brief This function returns a reference to member data
     * @return Reference to member data
     */
    FASTDDS_EXPORTED_API float& data();
