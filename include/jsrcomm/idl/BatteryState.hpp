...
public:
     ...
     */
    FASTDDS_EXPORTED_API BatteryState();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~BatteryState() override;
     ...
     * @param x Reference to the object sensor_msgs::msg::BatteryState that will be copied.
     */
    FASTDDS_EXPORTED_API BatteryState& operator =(
            const BatteryState& x);
     ...
     */
    FASTDDS_EXPORTED_API void charge(
            float _charge);
     ...
     */
    FASTDDS_EXPORTED_API void capacity(
            float _capacity);
     ...
     */
    FASTDDS_EXPORTED_API void design_capacity(
     ...
     */
    FASTDDS_EXPORTED_API void percentage(
            float _percentage);
     ...
     */
    FASTDDS_EXPORTED_API void power_supply_status(
     ...
     */
    FASTDDS_EXPORTED_API void power_supply_health(
     ...
     */
    FASTDDS_EXPORTED_API void power_supply_technology(
     ...
     */
    FASTDDS_EXPORTED_API uint8_t power_supply_technology() const;
     ...
     */
    FASTDDS_EXPORTED_API uint8_t& power_supply_technology();
     ...
     */
    FASTDDS_EXPORTED_API void present(
            bool _present);
     ...
     */
    FASTDDS_EXPORTED_API void cell_voltage(
     ...
     */
    FASTDDS_EXPORTED_API const std::vector<float>& cell_voltage() const;

    /*!
     * @brief This function returns a reference to member cell_voltage
     * @return Reference to member cell_voltage
     */
    FASTDDS_EXPORTED_API std::vector<float>& cell_voltage();
     ...
     */
    FASTDDS_EXPORTED_API void cell_temperature(
     ...
     */
    FASTDDS_EXPORTED_API const std::vector<float>& cell_temperature() const;

    /*!
     * @brief This function returns a reference to member cell_temperature
     * @return Reference to member cell_temperature
     */
    FASTDDS_EXPORTED_API std::vector<float>& cell_temperature();
     ...
     */
    FASTDDS_EXPORTED_API void location(
     ...
     */
    FASTDDS_EXPORTED_API void serial_number(
