...
public:
     ...
     */
    FASTDDS_EXPORTED_API AccelStamped();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~AccelStamped() override;
     ...
     * @param x Reference to the object geometry_msgs::msg::AccelStamped that will be copied.
     */
    FASTDDS_EXPORTED_API AccelStamped& operator =(
            const AccelStamped& x);
    ...
    /*!
     * @brief This function copies the value in member accel_
     * @param _accel_ New value to be copied in member accel_
     */
    FASTDDS_EXPORTED_API void accel_(
            const geometry_msgs::msg::Accel& _accel_);

    /*!
     * @brief This function moves the value in member accel_
     * @param _accel_ New value to be moved in member accel_
     */
    FASTDDS_EXPORTED_API void accel_(
            geometry_msgs::msg::Accel&& _accel_);

    /*!
     * @brief This function returns a constant reference to member accel_
     * @return Constant reference to member accel_
     */
    FASTDDS_EXPORTED_API const geometry_msgs::msg::Accel& accel_() const;

    /*!
     * @brief This function returns a reference to member accel_
     * @return Reference to member accel_
     */
    FASTDDS_EXPORTED_API geometry_msgs::msg::Accel& accel_();
...
private:
    ...
    geometry_msgs::msg::Accel m_accel_;
