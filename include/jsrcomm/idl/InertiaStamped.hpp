 ...
 */
class InertiaStamped : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API InertiaStamped();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~InertiaStamped() override;
     ...
     * @param x Reference to the object geometry_msgs::msg::InertiaStamped that will be copied.
     */
    FASTDDS_EXPORTED_API InertiaStamped& operator =(
            const InertiaStamped& x);
    ...
    /*!
     * @brief This function copies the value in member inertia_
     * @param _inertia_ New value to be copied in member inertia_
     */
    FASTDDS_EXPORTED_API void inertia_(
            const geometry_msgs::msg::Inertia& _inertia_);

    /*!
     * @brief This function moves the value in member inertia_
     * @param _inertia_ New value to be moved in member inertia_
     */
    FASTDDS_EXPORTED_API void inertia_(
            geometry_msgs::msg::Inertia&& _inertia_);

    /*!
     * @brief This function returns a constant reference to member inertia_
     * @return Constant reference to member inertia_
     */
    FASTDDS_EXPORTED_API const geometry_msgs::msg::Inertia& inertia_() const;

    /*!
     * @brief This function returns a reference to member inertia_
     * @return Reference to member inertia_
     */
    FASTDDS_EXPORTED_API geometry_msgs::msg::Inertia& inertia_();
...
private:
    ...
    geometry_msgs::msg::Inertia m_inertia_;
