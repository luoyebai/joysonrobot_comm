...
public:
     ...
     */
    FASTDDS_EXPORTED_API Transform();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~Transform() override;
     ...
     * @param x Reference to the object geometry_msgs::msg::Transform that will be copied.
     */
    FASTDDS_EXPORTED_API Transform& operator =(
            const Transform& x);
     ...
     */
    FASTDDS_EXPORTED_API void translation(
     ...
     */
    FASTDDS_EXPORTED_API const geometry_msgs::msg::Vector3& translation() const;

    /*!
     * @brief This function returns a reference to member translation
     * @return Reference to member translation
     */
    FASTDDS_EXPORTED_API geometry_msgs::msg::Vector3& translation();
     ...
     */
    FASTDDS_EXPORTED_API void rotation(
     ...
     */
    FASTDDS_EXPORTED_API const geometry_msgs::msg::Quaternion& rotation() const;

    /*!
     * @brief This function returns a reference to member rotation
     * @return Reference to member rotation
     */
    FASTDDS_EXPORTED_API geometry_msgs::msg::Quaternion& rotation();
