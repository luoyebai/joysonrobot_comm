 ...
 * @ingroup Int16
 */
class Int16 : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API Int16();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~Int16() override;
     ...
     * @param x Reference to the object std_msgs::msg::Int16 that will be copied.
     */
    FASTDDS_EXPORTED_API Int16& operator =(
            const Int16& x);
     ...
     */
    FASTDDS_EXPORTED_API int16_t data() const;

    /*!
     * @brief This function returns a reference to member data
     * @return Reference to member data
     */
    FASTDDS_EXPORTED_API int16_t& data();
