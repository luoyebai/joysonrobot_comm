...
public:
     ...
     */
    FASTDDS_EXPORTED_API Quaternion();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~Quaternion() override;
     ...
     * @param x Reference to the object geometry_msgs::msg::Quaternion that will be copied.
     */
    FASTDDS_EXPORTED_API Quaternion& operator =(
            const Quaternion& x);
