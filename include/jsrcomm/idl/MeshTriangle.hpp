 ...
 */
class MeshTriangle : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API MeshTriangle();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~MeshTriangle() override;
     ...
     * @param x Reference to the object shape_msgs::msg::MeshTriangle that will be copied.
     */
    FASTDDS_EXPORTED_API MeshTriangle& operator =(
            const MeshTriangle& x);
     ...
     */
    FASTDDS_EXPORTED_API void vertex_indices(
     ...
     */
    FASTDDS_EXPORTED_API const shape_msgs::msg::uint32__3& vertex_indices() const;

    /*!
     * @brief This function returns a reference to member vertex_indices
     * @return Reference to member vertex_indices
     */
    FASTDDS_EXPORTED_API shape_msgs::msg::uint32__3& vertex_indices();
...
private:
    ...
    shape_msgs::msg::uint32__3 m_vertex_indices{0};
