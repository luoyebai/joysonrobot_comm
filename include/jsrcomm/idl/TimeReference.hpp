 ...
 */
class TimeReference : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API TimeReference();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~TimeReference() override;
     ...
     * @param x Reference to the object sensor_msgs::msg::TimeReference that will be copied.
     */
    FASTDDS_EXPORTED_API TimeReference& operator =(
            const TimeReference& x);
     ...
     */
    FASTDDS_EXPORTED_API void time_ref(
     ...
     */
    FASTDDS_EXPORTED_API const builtin_interfaces::msg::Time& time_ref() const;

    /*!
     * @brief This function returns a reference to member time_ref
     * @return Reference to member time_ref
     */
    FASTDDS_EXPORTED_API builtin_interfaces::msg::Time& time_ref();
     ...
     */
    FASTDDS_EXPORTED_API void source(
