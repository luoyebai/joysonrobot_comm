 ...
 */
class PoseWithCovariance : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API PoseWithCovariance();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~PoseWithCovariance() override;
     ...
     * @param x Reference to the object geometry_msgs::msg::PoseWithCovariance that will be copied.
     */
    FASTDDS_EXPORTED_API PoseWithCovariance& operator =(
            const PoseWithCovariance& x);
    ...
    FASTDDS_EXPORTED_API void pose_val(
            const geometry_msgs::msg::Pose& _pose_val);
...
private:
    ...
    geometry_msgs::msg::Pose m_pose_val;
