...
public:
     ...
     */
    FASTDDS_EXPORTED_API TransformStamped();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~TransformStamped() override;
     ...
     * @param x Reference to the object geometry_msgs::msg::TransformStamped that will be copied.
     */
    FASTDDS_EXPORTED_API TransformStamped& operator =(
            const TransformStamped& x);
    ...
    /*!
     * @brief This function copies the value in member transform_
     * @param _transform_ New value to be copied in member transform_
     */
    FASTDDS_EXPORTED_API void transform_(
            const geometry_msgs::msg::Transform& _transform_);

    /*!
     * @brief This function moves the value in member transform_
     * @param _transform_ New value to be moved in member transform_
     */
    FASTDDS_EXPORTED_API void transform_(
            geometry_msgs::msg::Transform&& _transform_);

    /*!
     * @brief This function returns a constant reference to member transform_
     * @return Constant reference to member transform_
     */
    FASTDDS_EXPORTED_API const geometry_msgs::msg::Transform& transform_() const;

    /*!
     * @brief This function returns a reference to member transform_
     * @return Reference to member transform_
     */
    FASTDDS_EXPORTED_API geometry_msgs::msg::Transform& transform_();
...
private:
    ...
    geometry_msgs::msg::Transform m_transform_;
