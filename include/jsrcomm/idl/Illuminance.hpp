 ...
 * @ingroup Illuminance
 */
class Illuminance : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API Illuminance();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~Illuminance() override;
     ...
     * @param x Reference to the object sensor_msgs::msg::Illuminance that will be copied.
     */
    FASTDDS_EXPORTED_API Illuminance& operator =(
            const Illuminance& x);
     ...
     */
    FASTDDS_EXPORTED_API void illuminance(
            double _illuminance);
