 ...
 * @ingroup GridCells
 */
class GridCells : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API GridCells();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~GridCells() override;
     ...
     * @param x Reference to the object nav_msgs::msg::GridCells that will be copied.
     */
    FASTDDS_EXPORTED_API GridCells& operator =(
            const GridCells& x);
     ...
     */
    FASTDDS_EXPORTED_API void cell_width(
            float _cell_width);
     ...
     */
    FASTDDS_EXPORTED_API void cell_height(
            float _cell_height);
     ...
     */
    FASTDDS_EXPORTED_API void cells(
     ...
     */
    FASTDDS_EXPORTED_API const std::vector<geometry_msgs::msg::Point>& cells() const;

    /*!
     * @brief This function returns a reference to member cells
     * @return Reference to member cells
     */
    FASTDDS_EXPORTED_API std::vector<geometry_msgs::msg::Point>& cells();
