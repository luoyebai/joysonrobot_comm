 ...
 * @ingroup Mesh
 */
class Mesh : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API Mesh();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~Mesh() override;
     ...
     * @param x Reference to the object shape_msgs::msg::Mesh that will be copied.
     */
    FASTDDS_EXPORTED_API Mesh& operator =(
            const Mesh& x);
     ...
     */
    FASTDDS_EXPORTED_API void triangles(
     ...
     */
    FASTDDS_EXPORTED_API const std::vector<shape_msgs::msg::MeshTriangle>& triangles() const;

    /*!
     * @brief This function returns a reference to member triangles
     * @return Reference to member triangles
     */
    FASTDDS_EXPORTED_API std::vector<shape_msgs::msg::MeshTriangle>& triangles();
     ...
     */
    FASTDDS_EXPORTED_API void vertices(
     ...
     */
    FASTDDS_EXPORTED_API const std::vector<geometry_msgs::msg::Point>& vertices() const;

    /*!
     * @brief This function returns a reference to member vertices
     * @return Reference to member vertices
     */
    FASTDDS_EXPORTED_API std::vector<geometry_msgs::msg::Point>& vertices();
