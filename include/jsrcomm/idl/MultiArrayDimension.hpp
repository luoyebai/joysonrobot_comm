 ...
 */
class MultiArrayDimension : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API MultiArrayDimension();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~MultiArrayDimension() override;
     ...
     * @param x Reference to the object std_msgs::msg::MultiArrayDimension that will be copied.
     */
    FASTDDS_EXPORTED_API MultiArrayDimension& operator =(
            const MultiArrayDimension& x);
     ...
     */
    FASTDDS_EXPORTED_API void label(
     ...
     */
    FASTDDS_EXPORTED_API void size(
            uint32_t _size);
     ...
     */
    FASTDDS_EXPORTED_API void stride(
            uint32_t _stride);
