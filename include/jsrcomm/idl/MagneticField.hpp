 ...
 */
class MagneticField : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API MagneticField();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~MagneticField() override;
     ...
     * @param x Reference to the object sensor_msgs::msg::MagneticField that will be copied.
     */
    FASTDDS_EXPORTED_API MagneticField& operator =(
            const MagneticField& x);
     ...
     */
    FASTDDS_EXPORTED_API void magnetic_field(
     ...
     */
    FASTDDS_EXPORTED_API const geometry_msgs::msg::Vector3& magnetic_field() const;

    /*!
     * @brief This function returns a reference to member magnetic_field
     * @return Reference to member magnetic_field
     */
    FASTDDS_EXPORTED_API geometry_msgs::msg::Vector3& magnetic_field();
     ...
     */
    FASTDDS_EXPORTED_API void magnetic_field_covariance(
     ...
     */
    FASTDDS_EXPORTED_API const sensor_msgs::msg::double__9& magnetic_field_covariance() const;
     ...
     */
    FASTDDS_EXPORTED_API sensor_msgs::msg::double__9& magnetic_field_covariance();
