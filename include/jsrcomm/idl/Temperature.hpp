 ...
 * @ingroup Temperature
 */
class Temperature : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API Temperature();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~Temperature() override;
     ...
     * @param x Reference to the object sensor_msgs::msg::Temperature that will be copied.
     */
    FASTDDS_EXPORTED_API Temperature& operator =(
            const Temperature& x);
