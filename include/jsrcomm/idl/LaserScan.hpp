...
public:
     ...
     */
    FASTDDS_EXPORTED_API LaserScan();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~LaserScan() override;
     ...
     * @param x Reference to the object sensor_msgs::msg::LaserScan that will be copied.
     */
    FASTDDS_EXPORTED_API LaserScan& operator =(
            const LaserScan& x);
     ...
     */
    FASTDDS_EXPORTED_API const std::vector<float>& ranges() const;

    /*!
     * @brief This function returns a reference to member ranges
     * @return Reference to member ranges
     */
    FASTDDS_EXPORTED_API std::vector<float>& ranges();
     ...
     */
    FASTDDS_EXPORTED_API const std::vector<float>& intensities() const;

    /*!
     * @brief This function returns a reference to member intensities
     * @return Reference to member intensities
     */
    FASTDDS_EXPORTED_API std::vector<float>& intensities();
