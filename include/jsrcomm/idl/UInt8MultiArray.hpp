 ...
 */
class UInt8MultiArray : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API UInt8MultiArray();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~UInt8MultiArray() override;
     ...
     * @param x Reference to the object std_msgs::msg::UInt8MultiArray that will be copied.
     */
    FASTDDS_EXPORTED_API UInt8MultiArray& operator =(
            const UInt8MultiArray& x);
