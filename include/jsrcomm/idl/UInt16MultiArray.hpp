 ...
 */
class UInt16MultiArray : public eprosima::fastdds::dds::TopicDataType
{
public:
     ...
     */
    FASTDDS_EXPORTED_API UInt16MultiArray();

    /*!
     * @brief Default destructor.
     */
    FASTDDS_EXPORTED_API ~UInt16MultiArray() override;
     ...
     * @param x Reference to the object std_msgs::msg::UInt16MultiArray that will be copied.
     */
    FASTDDS_EXPORTED_API UInt16MultiArray& operator =(
            const UInt16MultiArray& x);
     ...
     */
    FASTDDS_EXPORTED_API const std::vector<uint16_t>& data() const;

    /*!
     * @brief This function returns a reference to member data
     * @return Reference to member data
     */
    FASTDDS_EXPORTED_API std::vector<uint16_t>& data();
